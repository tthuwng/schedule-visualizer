...
public class TextHandler {
	 ...
	 * schedule [class][5] = Weekdays1 (Sometimes Null)
	 * schedule [class][6] = Time1 (Sometimes Null)
	 * schedule [class][7] = Weekdays2 (Sometimes Null)
	 * schedule [class][8] = Time2 (Sometimes Null)
